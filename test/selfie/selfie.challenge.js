...
describe('[Challenge] Selfie', function () {
    ...
    it('Exploit', async function () {
        ...
        const SelfieHackFactory = await ethers.getContractFactory("SelfieHack", deployer);
        this.selfieHack = await SelfieHackFactory.deploy(this.pool.address, this.governance.address, attacker.address);

        await this.selfieHack.hack(TOKENS_IN_POOL);
